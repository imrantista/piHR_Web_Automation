...
import { TaskPage } from "../pages/Employee/Task/taskPage.js";
...
=======
import { SelfDashboardPage } from "../pages/Employee/SelfDashboard/SelfDashboardPage.js";
import {DocumentRequest} from "../pages/Employee/Operation/employeeDocumentRequestPage.js"
>>>>>>> master
...
export const test = baseTest.extend({
  ...
  task: async ({ page, context }, use) => {
    await use(new TaskPage(page, context));
  },
...
=======
  selfDashboard: async ({ page, context }, use) => {
    await use(new SelfDashboardPage(page, context));
  },
  
  documentRequest: async ({ page, context }, use) => {
    await use(new DocumentRequest(page, context));
>>>>>>> master
  }
});
