...
import { LeaveDashboardApis } from "../pages/Leave/Dashboard/LeaveDashboardApi.js";
...
export const test = baseTest.extend({
  ...
  leaveDashboardAllApis: async ({ page, context }, use) => {
    await use(new LeaveDashboardApis(page, context));
  },
});
